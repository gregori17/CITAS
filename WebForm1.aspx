<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WebForm1.aspx.vb" Inherits="CITAS.WebForm1" %>
                            ...
                            <div class="card-body table-wrapper-scroll-y my-custom-scrollbar">
                                <table class="table table-bordered" id="tabTab_Crear_LIsta" data-gera="_1G">
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            <th>
                                                <input type="text" class="form-control" id="txtValorLista" placeholder="Ingrese Nombre"></th>
                                            <th>
